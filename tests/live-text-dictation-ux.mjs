...
for(const forbidden of ['SpeechRecognition','webkitSpeechRecognition','WarehouseSpeechBroker.start','facoltativo','obbligatorio']){
...
console.log('Live text dictation UX OK: no browser speech engine, realtime textarea capture, clean actions and flexible position context.');
