...
(function installWarehouseManagerialV2Polish(){
  ...
  const VERSION='2026.08.26-managerial-v2-polish1';
  ...
  function install(){if(typeof document==='undefined')return false;wrapRenderStock();wrapCountConfirm();relabelSearch();return true}
  window.WarehouseManagerialV2Polish={version:VERSION,install,relabelSearch};install();
})();
