...
(function installWarehouseManagerialV2Polish(){
  ...
  const VERSION='2026.08.26-managerial-v2-polish2-assisted';
  ...
  function loadAssistedStockControl(){
    if(window.WarehouseStockControlAssistedV3){window.WarehouseStockControlAssistedV3.install?.();return true}
    if(document.getElementById('stockControlAssistedV3Js'))return true;
    const s=document.createElement('script');s.id='stockControlAssistedV3Js';s.src='stock-control-assisted-v3.js?v=20260826-assist3';s.async=false;s.onload=()=>window.WarehouseStockControlAssistedV3?.install?.();s.onerror=()=>console.error('Impossibile caricare stock-control-assisted-v3.js');document.body.appendChild(s);return true;
  }
  ...
  window.WarehouseManagerialV2Polish={version:VERSION,install,relabelSearch,loadAssistedStockControl};install();
})();
